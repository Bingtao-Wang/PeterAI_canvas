...
const imageLogStore = localforage.createInstance({ name: getStorageDatabaseName(), storeName: "image_generation_logs" });
const videoLogStore = localforage.createInstance({ name: getStorageDatabaseName(), storeName: "video_generation_logs" });
