...
- PeterAI 网站 Agent：右侧面板恢复“网站 / 本机”切换；网站模式应显示渠道 Base URL、默认文本模型和“配置 URL / API Key”入口，PeterAI 域名请求必须走同源 `/peter-api/v1/responses` 并计入站内 usage，手工第三方渠道保持浏览器直连；验证工具确认/拒绝、画布操作、站点工具、停止请求和用户隔离的模式偏好。
